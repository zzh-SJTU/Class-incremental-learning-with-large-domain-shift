...
class Inc_Learning_Appr:
    ...
    def train(self, t, trn_loader, val_loader, val_loader_1):
        self.pre_train_process(t, trn_loader)
        self.train_loop(t, trn_loader, val_loader, val_loader_1)
    ...
    def train_loop(self, t, trn_loader, val_loader,val_loader_1):
        ...
        for e in range(self.nepochs):
            ...
            clock3 = time.time()
            valid_loss, valid_acc, _ = self.eval(t, val_loader, val_loader_1)
            clock4 = time.time()
